...
def plot_nor(genotype, file_path, caption=None):
    """ make DAG plot and save to file_path as .png """
    edge_attr = {
        'fontsize': '20',
        'fontname': 'times'
...
def plot_red(genotype, file_path, caption=None):
    """ make DAG plot and save to file_path as .png """
    edge_attr = {
        'fontsize': '20',
        'fontname': 'times'
    ...
    # input nodes
    g.node("r_pre", fillcolor='darkseagreen2')
    g.node("n_pre", fillcolor='darkseagreen2')
